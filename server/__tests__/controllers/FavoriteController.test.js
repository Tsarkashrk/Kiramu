...
describe('POST /anime/:animeCode', () => {
  ...
  it('should return 400 if anime is already added to favorites', async () => {
    ...
    // Мокаем наличие записи о добавляемом аниме в избранном
  ...
  // Другие тесты на проверку обработки ошибок и других случаев
});

// Тесты для getFavorites
describe('GET /profile/favorites', () => {
...
describe('DELETE /anime/:animeCode/', () => {
  it('should remove a favorite anime', async () => {
    UserSchema.findById.mockResolvedValue(testUser);

    // Мокаем успешное удаление записи о добавленном аниме в избранном
  ...
  it('should return 404 if anime is not found in favorites', async () => {
    ...
    // Мокаем отсутствие записи о добавленном аниме в избранном
